...
echo "🚀 Setting up PDF & SKU Processor..."
...
echo "3. Upload your files and start processing!"
echo ""
echo "📋 What you can do:"
echo "   • Process PDF invoices → CSV reports or annotated PDFs"
echo "   • Extract SKUs from text → detailed CSV reports"
echo "   • Map SKUs to product specifications"
echo "   • Download processed files instantly"
echo ""
